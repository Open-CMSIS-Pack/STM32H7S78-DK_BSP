...
Virtual Resource  | Variable       | Physical Resource on STM32H7S78-DK                |
:-----------------|:---------------|:--------------------------------------------------|
vioBUTTON0        | vioSignalIn.0  | GPIO C.13: Button USER                            |
vioLED0           | vioSignalOut.0 | GPIO M.2:  LED3 (RED)                             |
vioLED1           | vioSignalOut.1 | GPIO O.1:  LED1 (GREEN)                           |
vioLED2           | vioSignalOut.2 | GPIO M.3:  LED4 (BLUE)                            |
vioLED3           | vioSignalOut.3 | GPIO O.5:  LED2 (ORANGE)                          |
*/
