/******************************************************************************
 * @file     vio_STM32H7S78-DK.c
 * @brief    Virtual I/O implementation for board STM32H7S78-DK
 * @version  V1.0.0
...
/*! \page vio_STM32H7S78-DK Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PM2
| vioLED1       | vioSignalOut.1 | LED green   (LD1)    | PO1
| vioLED2       | vioSignalOut.2 | LED blue    (LD4)    | PM3
| vioLED3       | vioSignalOut.3 | LED orange  (LD2)    | PO5
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTM(2),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTO(1),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTM(3),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED3,    GPIO_PIN_ID_PORTO(5),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
